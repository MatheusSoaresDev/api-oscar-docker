...
class AddAwardMovieToOscarRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        ...
        $awardArtistId = $this->route("awardMovieId");

        return [
            "year.exists" => "Ceremony hasn't been found on ".$year.".",
            "awardMovie_id.exists" => "Award hasn't been found with id: ".$awardArtistId.".",
        ];
    }
